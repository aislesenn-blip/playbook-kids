      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 space-y-12">
        ...
        <section>
          ...
          <div className="flex overflow-x-auto gap-6 pb-4 [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full" style={{ scrollSnapType: "x mandatory" }}>
            ...
            <motion.div whileHover={{ y: -5 }} className="bg-white rounded-3xl p-6 border border-border shadow-sm flex items-center gap-5 cursor-pointer h-full">
              ...
              <div>
                <h3 className="font-bold text-xl flex items-center gap-1 hover:text-primary transition-colors">Campus Thrift <div className="w-2 h-2 bg-primary rounded-full"></div></h3>
            ...
            <motion.div whileHover={{ y: -5 }} className="bg-white rounded-3xl p-6 border border-border shadow-sm flex items-center gap-5 cursor-pointer h-full">
              ...
              <div>
                <h3 className="font-bold text-xl flex items-center gap-1 hover:text-primary transition-colors">TechZone UDSM <div className="w-2 h-2 bg-primary rounded-full"></div></h3>
            ...
            {/* Store 3 */}
            <Link href="/store/v3" className="block min-w-[300px] shrink-0" style={{ scrollSnapAlign: "start" }}>
            <motion.div whileHover={{ y: -5 }} className="bg-white rounded-3xl p-6 border border-border shadow-sm flex items-center gap-5 cursor-pointer h-full">
              <div className="w-20 h-20 rounded-full overflow-hidden relative shrink-0 border border-gray-100 shadow-inner">
              ...
              <div>
                <h3 className="font-bold text-xl flex items-center gap-1 hover:text-primary transition-colors">Kicks TZ <div className="w-2 h-2 bg-primary rounded-full"></div></h3>
