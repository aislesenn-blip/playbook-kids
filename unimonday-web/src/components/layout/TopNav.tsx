...
export function TopNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-20 bg-[#FAFAFA]/95 backdrop-blur-md border-b border-zinc-100 z-[100] flex items-center px-4 md:px-8 justify-between shadow-[0_4px_40px_rgba(0,0,0,0.02)]">
      ...
      {profile ? (
        ...
        <div className="flex items-center gap-4">
           ...
           <Link href="/auth/signup" className="px-6 py-2.5 bg-zinc-900 text-white rounded-2xl font-medium text-sm hover:bg-zinc-800 transition-colors shadow-sm">
             Create Profile
           </Link>
        </div>
      )}
