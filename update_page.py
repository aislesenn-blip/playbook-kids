...
# I will do a massive overhaul of the page to implement all requested features.
# It is better to write the new component entirely to ensure all states work properly with Framer Motion.

new_content = """\"use client\";

import { useState, useEffect } from \"react\";
import { motion, AnimatePresence } from \"framer-motion\";
import { Send, Loader2, CheckCircle, Terminal, Globe, RefreshCcw, LayoutTemplate, Briefcase, Store, PenTool, Code2, Sparkles, Database, Layers } from \"lucide-react\";
